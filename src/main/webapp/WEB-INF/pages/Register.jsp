                   ...
                   <br>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <input type="radio" class="form-check-input" id="english" name="Language" value="english">
                            <label class="form-check-label" for="english">C</label>
                        </div>
                        <br>


                        <div class="form-check">
                            <input type="radio" class="form-check-input" id="spanish" name="Language" value="spanish">
                            <label class="form-check-label" for="spanish">C++</label>
                        </div>
                        <br>
                         <div class="form-check">
                                                    <input type="radio" class="form-check-input" id="spanish" name="Language" value="spanish">
                                                    <label class="form-check-label" for="spanish">JAVA</label>
                                                </div>
